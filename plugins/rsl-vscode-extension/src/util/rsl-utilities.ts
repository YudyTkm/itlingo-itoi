...
function getVulnerabilities(system: System) {
...
function getRisks(system: System) {
    let elements: Risk[] = [];
...
function getStakeholders(system: System) {
...
function getActors(system: System) {
    let elements: Actor[] = [];
...
function getStateMachines(system: System) {
...
function getActiveTasks(system: System) {
...
function getActiveEvents(system: System) {
...
function getActiveFlows(system: System) {
...
function getGoals(system: System) {
    let elements: Goal[] = [];
...
function getConstraints(system: System) {
...
function getUserStories(system: System) {
...
function getUseCases(system: System) {
...
function getDataEnumerations(system: System) {
...
function getDataEntities(system: System) {
...
function getDataEntityClusters(system: System) {
...
function getData(system: System) {
    let elements: Data[] = [];
...
function getMainScenarios(system: System) {
...
function getScenarios(system: System) {
...
function getSteps(system: System) {
    let elements: Step[] = [];
...
function getDataAttributes(system: System) {
