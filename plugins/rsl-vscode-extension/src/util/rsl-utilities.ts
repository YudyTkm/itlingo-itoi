...
function getDataAttributeElementsProperty(
  system: System,
...
function getMainScenarioElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getDataEntityClusterElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getDataEntityElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getDataEnumerationElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getConstraintElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getActiveFlowElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getActiveEventElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getActiveTaskElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getStateMachineElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getStakeholderElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getVulnerabilityElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
...
function getGlossaryTermElementsProperty(
  system: System,
  desiredProperty: string
) {
  let elements = new Set<string>();
  ...
  for (let element of system.systemConcepts) {
    if (isVulnerability(element)) {
      ...
      if (
        ...
        isVulnerability(includeElement.element.ref)
      ) {
  ...
  for (let element of system.systemConcepts) {
    if (isRisk(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isRisk(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isStakeholder(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isStakeholder(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isActor(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isActor(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isStateMachine(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isStateMachine(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isActiveTask(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isActiveTask(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isActiveEvent(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isActiveEvent(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isActiveFlow(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isActiveFlow(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isGoal(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isGoal(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isQR(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isQR(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isFR(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isFR(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isConstraint(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isConstraint(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
 ...
 */
export function getLinguisticLanguageType(
  system: System
): LinguisticLanguageType {
  ...
  for (let element of system.systemConcepts) {
    if (isLinguisticRule(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isLinguisticRule(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isUserStory(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isUserStory(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isGlossaryTerm(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isGlossaryTerm(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
 ...
 *         otherwise false.
 */
export function isGlossaryTermApplicableTo(
  term: GlossaryTerm,
  element: SystemConcept
): boolean {
  ...
  for (let element of system.systemConcepts) {
    if (isUseCase(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isUseCase(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isDataEnumeration(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isDataEnumeration(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isDataEntity(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isDataEntity(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isDataEntityCluster(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isDataEntityCluster(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isData(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isData(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
  ...
  for (let element of system.systemConcepts) {
    if (isDataAttribute(element)) {
      ...
      if (
        includeElement.element &&
        includeElement.element.ref &&
        isDataAttribute(includeElement.element.ref)
      ) {
        elements.push(includeElement.element.ref);
      }
    } else if (isIncludeAll(element)) {
...
function createDataEnumeration(
  elementProperty: string,
  ruleProperty: LinguisticRuleElementProperty
): string {
  const elementPropertyId = elementProperty.replaceAll("\\s+", "");
...
function createDataEntityCluster(
  elementProperty: string,
  ruleProperty: LinguisticRuleElementProperty
): string {
  const elementPropertyId = elementProperty.replaceAll("\\s+", "");
