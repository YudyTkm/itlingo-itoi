...
export type LinguisticElement = LinguisticFragment | LinguisticLanguage | LinguisticRule;
...
export function isLinguisticLanguageType_de(item: unknown): item is LinguisticLanguageType_de {
    return item === 'German';
}

export type LinguisticLanguageType_en = 'English';

export function isLinguisticLanguageType_en(item: unknown): item is LinguisticLanguageType_en {
    return item === 'English';
}

export type LinguisticLanguageType_es = 'Spanish';

export function isLinguisticLanguageType_es(item: unknown): item is LinguisticLanguageType_es {
    return item === 'Spanish';
}

export type LinguisticLanguageType_fr = 'French';

export function isLinguisticLanguageType_fr(item: unknown): item is LinguisticLanguageType_fr {
    return item === 'French';
}

export type LinguisticLanguageType_it = 'Italian';
...
export function isLinguisticLanguageType_pt(item: unknown): item is LinguisticLanguageType_pt {
...
export function isLinguisticRuleElementProperty_description(item: unknown): item is LinguisticRuleElementProperty_description {
    return item === 'description';
}

export type LinguisticRuleElementProperty_id = 'id';

export function isLinguisticRuleElementProperty_id(item: unknown): item is LinguisticRuleElementProperty_id {
    return item === 'id';
}

export type LinguisticRuleElementProperty_name = 'name';

export function isLinguisticRuleElementProperty_name(item: unknown): item is LinguisticRuleElementProperty_name {
    return item === 'name';
}
...
export function isLinguisticRuleSeverityLevel_error(item: unknown): item is LinguisticRuleSeverityLevel_error {
    return item === 'Error';
}

export type LinguisticRuleSeverityLevel_warning = 'Warning';

export function isLinguisticRuleSeverityLevel_warning(item: unknown): item is LinguisticRuleSeverityLevel_warning {
    return item === 'Warning';
}
...
export type PartOfSpeechEnum = 'Adjective' | 'Adposition' | 'Adverb' | 'Auxiliary' | 'CoordinatingConjunction' | 'Determiner' | 'Interjection' | 'Noun' | 'Numeral' | 'Other' | 'Particle' | 'Pronoun' | 'ProperNoun' | 'Punctuation' | 'SubordinatingConjunction' | 'Symbol' | 'Verb';

export type PartOfSpeechEnum_ADJ = 'Adjective';

export function isPartOfSpeechEnum_ADJ(item: unknown): item is PartOfSpeechEnum_ADJ {
    return item === 'Adjective';
}

export type PartOfSpeechEnum_ADP = 'Adposition';

export function isPartOfSpeechEnum_ADP(item: unknown): item is PartOfSpeechEnum_ADP {
    return item === 'Adposition';
}

export type PartOfSpeechEnum_ADV = 'Adverb';

export function isPartOfSpeechEnum_ADV(item: unknown): item is PartOfSpeechEnum_ADV {
    return item === 'Adverb';
}

export type PartOfSpeechEnum_AUX = 'Auxiliary';

export function isPartOfSpeechEnum_AUX(item: unknown): item is PartOfSpeechEnum_AUX {
    return item === 'Auxiliary';
}

export type PartOfSpeechEnum_CCONJ = 'CoordinatingConjunction';

export function isPartOfSpeechEnum_CCONJ(item: unknown): item is PartOfSpeechEnum_CCONJ {
    return item === 'CoordinatingConjunction';
}

export type PartOfSpeechEnum_DET = 'Determiner';

export function isPartOfSpeechEnum_DET(item: unknown): item is PartOfSpeechEnum_DET {
    return item === 'Determiner';
}

export type PartOfSpeechEnum_INTJ = 'Interjection';

export function isPartOfSpeechEnum_INTJ(item: unknown): item is PartOfSpeechEnum_INTJ {
    return item === 'Interjection';
}

export type PartOfSpeechEnum_NOUN = 'Noun';

export function isPartOfSpeechEnum_NOUN(item: unknown): item is PartOfSpeechEnum_NOUN {
    return item === 'Noun';
}

export type PartOfSpeechEnum_NUM = 'Numeral';

export function isPartOfSpeechEnum_NUM(item: unknown): item is PartOfSpeechEnum_NUM {
    return item === 'Numeral';
}

export type PartOfSpeechEnum_PART = 'Particle';

export function isPartOfSpeechEnum_PART(item: unknown): item is PartOfSpeechEnum_PART {
    return item === 'Particle';
}

export type PartOfSpeechEnum_PRON = 'Pronoun';

export function isPartOfSpeechEnum_PRON(item: unknown): item is PartOfSpeechEnum_PRON {
    return item === 'Pronoun';
}

export type PartOfSpeechEnum_PROPN = 'ProperNoun';

export function isPartOfSpeechEnum_PROPN(item: unknown): item is PartOfSpeechEnum_PROPN {
    return item === 'ProperNoun';
}

export type PartOfSpeechEnum_PUNCT = 'Punctuation';

export function isPartOfSpeechEnum_PUNCT(item: unknown): item is PartOfSpeechEnum_PUNCT {
    return item === 'Punctuation';
}

export type PartOfSpeechEnum_SCONJ = 'SubordinatingConjunction';

export function isPartOfSpeechEnum_SCONJ(item: unknown): item is PartOfSpeechEnum_SCONJ {
    return item === 'SubordinatingConjunction';
}

export type PartOfSpeechEnum_SYM = 'Symbol';

export function isPartOfSpeechEnum_SYM(item: unknown): item is PartOfSpeechEnum_SYM {
    return item === 'Symbol';
}

export type PartOfSpeechEnum_VERB = 'Verb';

export function isPartOfSpeechEnum_VERB(item: unknown): item is PartOfSpeechEnum_VERB {
    return item === 'Verb';
}

export type PartOfSpeechEnum_X = 'Other';

export function isPartOfSpeechEnum_X(item: unknown): item is PartOfSpeechEnum_X {
    return item === 'Other';
}
...
export interface DateRule extends AstNode {
    readonly $container: AttributeValue;
    readonly $type: 'DateRule';
    day: number
    month: number
    year: number
}

export const DateRule = 'DateRule';

export function isDateRule(item: unknown): item is DateRule {
    return reflection.isInstance(item, DateRule);
}
...
export interface IncludeElement extends AstNode {
    ...
    description?: string
    element: Reference<SystemConcept>
    system: Reference<System>
    tags: Array<Tag>
...
export interface IncludeSystemElementType extends AstNode {
    ...
    type: 'AcceptanceCriteriaTestView' | 'ActiveEvent' | 'ActiveFlow' | 'ActiveTask' | 'Actor' | 'Constraint' | 'DataEntity' | 'DataEntityCluster' | 'DataEntityTestView' | 'DataEnumeration' | 'FR' | 'GlossaryTerm' | 'Goal' | 'LinguisticFragment' | 'LinguisticRule' | 'QR' | 'Risk' | 'Stakeholder' | 'StateMachine' | 'StatemachineTestView' | 'UseCase' | 'UseCaseTestView' | 'UserStory' | 'Vulnerability'
}
...
export interface LinguisticFragmentRef extends AstNode {
    readonly $container: LinguisticFragment | LinguisticPattern | LinguisticRule;
...
export interface LinguisticLanguage extends AstNode {
    readonly $container: System | TestSuite | Threat;
    readonly $type: 'LinguisticLanguage';
    description?: string
    name: string
    nameAlias?: string
    type: LinguisticLanguageType
}

export const LinguisticLanguage = 'LinguisticLanguage';

export function isLinguisticLanguage(item: unknown): item is LinguisticLanguage {
    return reflection.isInstance(item, LinguisticLanguage);
}
...
export interface LinguisticRule extends AstNode {
    ...
    property: LinguisticRuleElementAndProperty
...
export interface LinguisticRuleElement extends AstNode {
    readonly $container: LinguisticRuleElementAndProperty;
...
export type RslAstType = {
    ...
    LinguisticLanguage: LinguisticLanguage
